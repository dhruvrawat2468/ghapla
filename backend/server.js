...
import technicianAuthRoutes from "./routes/technicianAuthRoutes.js"; // New technician auth routes
...
app.use(
  cors({
    origin: ["http://192.168.1.13:8081", "http://192.168.1.13:8082", "exp://192.168.1.13:8082", "*"], // Allow all origins for testing
...
app.use('/auth/technician', technicianAuthRoutes); // New technician auth routes
